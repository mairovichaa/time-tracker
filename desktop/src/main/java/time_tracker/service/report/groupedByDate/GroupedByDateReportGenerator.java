...
public class GroupedByDateReportGenerator {
    ...
    public String generate(@NonNull final ReportState reportState) {
        Map<LocalDate, List<StopwatchRecord>> dateToRecords = reportState.getDateToRecords();
        Map<String, List<StopwatchRecordExportDto>> mappedChosenRecords = mapper.map(dateToRecords);
